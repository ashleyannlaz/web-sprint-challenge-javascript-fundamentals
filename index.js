...
function summation(number) {
  ...
  console.log("Summation", summation(5)) // 15
  console.log("Summation", summation(4)) // 10
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log("Topic 3: Volume", cuboid.volume()); // 100
console.log("Topic 3: Surface Area", cuboid.surfaceArea()); // 130
